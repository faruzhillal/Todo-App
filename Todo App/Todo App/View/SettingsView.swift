...
//  Todo App
//
//  Created by Faruz Hillal Albany on 19/02/21.
//
            ...
            VStack(alignment: .center, spacing:0){
                Form {
                    ...
                    Section(header: Text("Follow us on social media")) {
                        FormRowLinkView(icon: "Instagram", color: Color.pink, text: "Website", link: "https://www.instagram.com/faruz_bany/")
                        FormRowLinkView(icon: "Facebook", color: Color.blue, text: "Twitter", link: "https://m.facebook.com/faruz.bany")
